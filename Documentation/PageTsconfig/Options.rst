...
..  accordion::
    :name: pagebackendlayout

    ..  accordion-item:: backendLayout.exclude
        :name: pagebackendlayout-exclude
        ...
        ..  rubric:: Example: Exclude two backend layouts from drop down selector
            :name: pagebackendlayout-example
    ...
    ..  accordion-item:: defaultUploadFolder
        :name: pagedefaultuploadfolder
        ...
        ..  rubric:: Example: Set default upload
            :name: pagedefaultuploadfolder-example
