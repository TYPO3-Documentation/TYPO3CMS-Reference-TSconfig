...
..  confval:: folderTree.hideCreateFolder
...
..  confval:: hideModules
    ...
    It is not an access restriction but makes defined modules invisible. That
    means in principle those modules can still be accessed if the rights allow.

    A list of all available module groups and modules can be found in in the
    backend module :guilabel:`System > Configuration > $GLOBALS['TBE_MODULES'] (BE Modules)`
